...
object TUserInfo extends ValidatingThriftStructCodec3[TUserInfo] {
  ...
  private[this] def lazyDecode(_iprot: LazyTProtocol): TUserInfo = {
    ...
    var roles: Seq[xed.caas.domain.thrift.TRoleInfo] = Seq[xed.caas.domain.thrift.TRoleInfo]()
  ...
  def apply(
    ...
    isActive: Boolean,
    createTime: Long,
    roles: Seq[xed.caas.domain.thrift.TRoleInfo] = Seq[xed.caas.domain.thrift.TRoleInfo]()
  ): TUserInfo =
    new Immutable(
      username,
      isActive,
  ...
  def unapply(_item: TUserInfo): _root_.scala.Option[_root_.scala.Tuple4[String, Boolean, Long, Seq[xed.caas.domain.thrift.TRoleInfo]]] = _root_.scala.Some(_item.toTuple)
  ...
  class Immutable(
      ...
      val createTime: Long,
      val roles: Seq[xed.caas.domain.thrift.TRoleInfo],
  ...
  trait Proxy extends TUserInfo {
    ...
    override def roles: Seq[xed.caas.domain.thrift.TRoleInfo] = _underlying_TUserInfo.roles
    override def _passthroughFields = _underlying_TUserInfo._passthroughFields
  }
}

/**
 * Prefer the companion object's [[xed.caas.domain.thrift.TUserInfo.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TUserInfo
  extends ThriftStruct
  with _root_.scala.Product4[String, Boolean, Long, Seq[xed.caas.domain.thrift.TRoleInfo]]
  ...
  with java.io.Serializable
{
  ...
  def createTime: Long
  def roles: Seq[xed.caas.domain.thrift.TRoleInfo]
  ...
  def toTuple: _root_.scala.Tuple4[String, Boolean, Long, Seq[xed.caas.domain.thrift.TRoleInfo]] = {
    (
      username,
      isActive,
      createTime,
  ...
  def setField(_blob: TFieldBlob): TUserInfo = {
    ...
    var roles: Seq[xed.caas.domain.thrift.TRoleInfo] = this.roles
  ...
  def unsetField(_fieldId: Short): TUserInfo = {
    ...
    _fieldId match {
      ...
      case 3 =>
        createTime = 0L
      case 4 =>
        roles = Seq[xed.caas.domain.thrift.TRoleInfo]()
      case _ =>
    }
    new Immutable(
      username,
  ...
  def copy(
    ...
    roles: Seq[xed.caas.domain.thrift.TRoleInfo] = this.roles,
